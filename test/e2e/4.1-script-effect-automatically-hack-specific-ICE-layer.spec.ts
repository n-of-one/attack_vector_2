// TODO: this test case relies on a hardcoded layer-id. Since this test case was made, importing now randomized layer-ids
//  This test needs to be rewritten to account for that change.
...
//         await hacker.typeCommand("view", "1 Tar ICE hacked")
