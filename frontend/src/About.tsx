        ...
        <div className="row text">
            <div className="col-12">
                ...
                <p>
                    ...
                    solving
                    puzzles like Word-search, Network jigsaw and Untangle. The sites form meta-puzzles where there can be timers to beat, passwords to find or other
                ...
                <p>
                    Attack Vector 2 is very privacy conscious and aims to not collect or store any personal information. To that end, no usernames, email addresses or
                    passwords are stored.
                    Login is done via an external system, such as your larp's website or Google. When Google is used, only a one-way hash of the google-id is stored, not
                ...
                <p>
                    ...
                    If you want to know more, have found a <a href="https://github.com/n-of-one/attack_vector_2/issues" target="_blank">bug</a>, or want help to use it in
...
license-checker                                    BSD-3-Clause  https://github.com/davglass/license-checker.git             Dav Glass &lt;davglass@gmail.com&gt;<br/>
...
react-router-dom                                   MIT           https://github.com/remix-run/react-router.git               Remix Software &lt;hello@remix.run&gt;<br/>
...
@reduxjs/toolkit                                   MIT           https://github.com/reduxjs/redux-toolkit.git                Mark Erikson &lt;mark@isquaredsoftware.com&gt;<br/>
