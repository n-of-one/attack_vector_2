...
import {BLOCK_HEIGHT, BLOCK_PADDING_BOTTOM, BLOCK_PADDING_LEFT, BLOCK_WIDTH, PADDING_LEFT, PADDING_TOP} from "./TarCanvas";

const TAR_FILL_COLOR = "#337ab7"

export class TarBlockDisplay {
    ...
    constructor(x: number, y: number, fillFractionInput: number, canvas: fabric.Canvas) {
        ...
        // if (fillFraction === 1) {
        //     this.fillBox = this.createRect(1, TAR_FILL_COLOR, 1, '#999')
        ...
        this.fillBox = this.createRect(fillFraction, TAR_FILL_COLOR, 0)
