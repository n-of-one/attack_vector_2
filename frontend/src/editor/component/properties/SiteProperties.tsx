                    ...
                    <div className="row form-group">
                            ...
                            <div className="col-lg-4">
                                <TextSaveInput id="start_node" className="form-control" placeholder="Network Id"
                                               ...
                                               save={(value: string) => save("START_NODE", value)}/>
                            </div>
                    </div>
                    <div className="row form-group">
                            <label htmlFor="nodesLocked" className="col-lg-5 control-label text-muted">Lock nodes</label>
                            <div className="col-lg-1">
                                <CheckboxSaveInput id="nodesLocked" className="form-control form-check-input" checked={siteProperties.nodesLocked}
                                                   save={(value: boolean) => save("NODES_LOCKED", value)} />
                            </div>
                    </div>
               </div>
            </div>
