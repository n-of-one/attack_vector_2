            ...
            <div className="row">
                <div className="col-12">
                    ...
                    <p className="text">
                        ...
                        <br/>
                        Attack Vector is <a href="https://github.com/n-of-one/attack_vector_2" target="_blank">open source</a> under the MIT license, meaning you can use
                    ...
                    <p className="text">
                        Attack Vector 2 can be changed to fit the aesthetic of a specific event, but this will require some development. I am happy to perform
                        some simple changes as long as the organization provides the graphics and cooperates in this process.<br/>
                        <br/>
                        A bigger effort is to connect the login of Attack Vector to the login of the event's website. I will help with this depending on the effort
                        involved.
                    </p>
                    <h3 className="muted">Privacy</h3>
                    <p className="text">
                        Attack Vector aims to be as privacy friendly as possible. It does not use cookies to track users, it does not store any personal information other
                        than the information stored in there by the game masters.<br/>
                        <br/>
                        Google Authentication is the default way of logging in so that the system does not know any real usernames or passwords. The system does not store
                    ...
                    <p className="text">
                        Version 1 of Attack Vector was first used on an event in 2016. This version did not support multiplayer like version 2. However, over the years a
                        lot of features
                        ...
                        <ul>
                            <li>Creation of site-templates<br/><br/>
                                One of the major challenges during an event, is that sometimes players come up with some system they want to hack, that the game-masters
                                did not anticipate. To solve this, version 1 allowed the game-masters to create a number of site-templates in advance, but without any
                                specific information in them.<br/><br/>
                                During the event, they could use a very simple web-form to create a site based on a template, and fill in the information that the players
