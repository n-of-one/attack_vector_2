            ...
            <div className="row">
                <div className="col-12">
                    ...
                    <p className="text">
                        ...
                        <br/>
                        Players will need a laptop and a browser (Chrome, Firefox, Safari) to play the game. It will not work on a mobile phone.<br/>
                        <br/>
                    ...
                    <p className="text">Create the sites that players can hack. More information <a href="/website/gms">here</a>.</p>
