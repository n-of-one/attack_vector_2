...
const notify_ok = (title: string, message: string, position: string) => {
    iziToast.show({
        title: title,
        message: message,
        position: position,
...
const notify_advice = (title: string, message: string, position: string) => {
    iziToast.show({
        title: title,
        message: message,
        position: position,
...
const notify = ({type, title, message} : {type: string, title: string, message: string}) => {
