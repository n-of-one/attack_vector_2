...
export const ConfigItemHackerUseDevCommands = (props: { value: string }) => {
    return (
        <>
            ...
            <div className="form-text text-muted text-size">Can hackers use commands that are only intended for developers?<br/><br/>
                Default: false<br/>
...
export const ConfigItemMinimumShutdownDuration = (props: { value: string }) => {
    return (
        <>
            ...
            <div className="form-text text-muted text-size">What is the minimum shutdown duration for a site?<br/><br/>
...
export const ConfigItemHackerResetSite = (props: { value: string }) => {
    return (
        <>
            ...
            <div className="form-text text-muted text-size">Can hackers reset a site? Resetting a site is normally caused by tripping a tripwire, or by a GM.<br/><br/>
                Default: false<br/>
                General advice: leave this to false.<br/><br/>
...
export const ConfigItemTestingMode = (props: { value: string }) => {
    return (
        <>
            ...
            <div className="form-text text-muted text-size">Enable testing mode, make ICE puzzles predictable<br/><br/>
                Default: false<br/>
                General advice: leave this to false.<br/><br/>
...
export const ConfigItemQuickPlaying = (props: { value: string }) => {
    return (
        <>
            ...
            <div className="form-text text-muted text-size">Skip most of the flavour text when accessing ICE.<br/><br/>
                Default: false<br/>
                General advice: leave this to false.<br/><br/>
...
export const ConfigItemDevSimulateNonLocalHost = (props: { value: string }) => {
    return (
        <>
            ...
            <div className="form-text text-muted text-size">Artificial delay when responding to network calls<br/><br/>
                Default: 0<br/>
