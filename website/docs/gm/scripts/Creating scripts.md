...
## Script effects
Each script consists of one or more effects. These effects can be useful or be a drawback. For a full list of script effects, see [here](/gm/scripts/Script%20effects)
