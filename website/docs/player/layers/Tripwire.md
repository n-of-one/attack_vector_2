...
Tripwire timers can be stopped by hacking the right core layer, see [here](/player/layers/Core). Hacking a tripwire will reveal in which node the core is located.
