# Install script
#
# Run this script after cloning the repo ( git clone https://github.com/n-of-one/attack_vector_2.git )
...
# Run
cd target
java -jar app.jar --server.port=8080 -Xmx512m -XX:MaxMetaspaceSize=256m
