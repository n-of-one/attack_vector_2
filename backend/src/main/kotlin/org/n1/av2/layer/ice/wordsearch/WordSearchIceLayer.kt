...
) : IceLayer(id, LayerType.WORD_SEARCH_ICE, level, name, note, strength, hacked, original) {

    constructor(id: String, level: Int, name: String, note: String, strength: IceStrength, hacked: Boolean, original: IceLayer?) :
        this(id, LayerType.WORD_SEARCH_ICE, level, name, note, strength, hacked, original)
