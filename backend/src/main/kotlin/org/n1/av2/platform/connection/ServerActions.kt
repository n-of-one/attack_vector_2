...
enum class ServerActions {
    ...
    SERVER_RECEIVE_INCOME_DATES,    // Send all income dates to the client

    SERVER_RECEIVE_CREDITS_TRANSACTIONS, // Send all credit transactions of a user to the client
