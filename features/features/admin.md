...
- Configuration categories:
  ...
  - **LARP-specific**: event name, Frontier/Lola features, Orthank token
...
Same capabilities as GM task monitor (view active backend tasks with due time, action, user, and identifiers).
